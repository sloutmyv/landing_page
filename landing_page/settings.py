...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-r@f7)y&ien0zi^$dw%v)lpf(ei-i@h$gibwv@1x)c7s@ejra)p')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='landing_page_db'),
...
BINANCE_TESTNET = config('BINANCE_TESTNET', default=False, cast=bool)
